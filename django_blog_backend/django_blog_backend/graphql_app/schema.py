...
from django_blog_backend.graphql_app.queries import Query

from django_blog_backend.graphql_app.mutations import (
    CreatePostMutation,
    UpdatePostMutation,
    DeletePostMutation,
...
from django_blog_backend.graphql_app.relay_mutations import (
