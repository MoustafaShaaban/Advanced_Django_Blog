...
from docker_blog_backend.api.serializers import PostSerializer, CommentSerializer, TagSerializer
from docker_blog_backend.api.permissions import PostPermissions, CommentPermissions
