...
from docker_blog_backend.blog import views
from docker_blog_backend.graphql_app.schema import schema

from docker_blog_backend.graphql_app.views import PrivateGraphQLView
