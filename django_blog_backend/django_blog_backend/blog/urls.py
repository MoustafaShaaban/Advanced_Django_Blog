...
from django_blog_backend.blog import views
from django_blog_backend.graphql_app.schema import schema

from django_blog_backend.graphql_app.views import PrivateGraphQLView
